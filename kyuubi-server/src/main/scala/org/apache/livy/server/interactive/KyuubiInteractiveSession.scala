...
object KyuubiInteractiveSession extends Logging {
...
//    val impersonatedUser = accessManager.checkImpersonation(proxyUser, owner)
  ...
  def recover(
      metadata: KyuubiInteractiveRecoveryMetadata,
      livyConf: LivyConf,
      sessionStore: SessionStore,
      mockApp: Option[SparkApp] = None,
      mockClient: Option[RSCClient] = None): KyuubiInteractiveSession = {
...
class KyuubiInteractiveSession(
    id: Int,
    name: Option[String],
  ...
  import KyuubiInteractiveSession._
  ...
  override def recoveryMetadata: RecoveryMetadata =
    KyuubiInteractiveRecoveryMetadata(id, name, appId, appTag, kind,
