 ...
 *
 */
abstract class Session extends Logging {
  protected val protocol: TProtocolVersion
  protected val username: String
  protected val password: String
  protected val conf: SparkConf
  protected val ipAddress: String
  protected val withImpersonation: Boolean
  protected val sessionManager: SessionManager
  protected val operationManager: OperationManager
