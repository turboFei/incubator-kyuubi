...
import yaooqinn.kyuubi.yarn.{KyuubiAmSessionManager, KyuubiAppMaster}
...
private[kyuubi] class SessionManager private(
  ...
  private var kyuubiAmSessionManager: KyuubiAmSessionManager = _
  ...
  override def init(conf: SparkConf): Unit = synchronized {
    ...
    if (conf.getBoolean(YARN_KYUUBIAPPMASTER_MODE.key, false)) {
      kyuubiAmSessionManager = new KyuubiAmSessionManager(kyuubiAppMaster)
  ...
  def getAmSessionManager: KyuubiAmSessionManager = kyuubiAmSessionManager
}
