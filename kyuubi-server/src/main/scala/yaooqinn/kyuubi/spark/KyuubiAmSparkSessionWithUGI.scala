...
import yaooqinn.kyuubi.yarn.KyuubiAmSessionManager

class KyuubiAmSparkSessionWithUGI(
    user: UserGroupInformation,
    conf: SparkConf,
    cache: KyuubiAmSessionManager) extends Logging {
  import KyuubiAmSparkSessionWithUGI._
...
object KyuubiAmSparkSessionWithUGI {
