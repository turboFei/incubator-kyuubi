...
<code>kyuubi.operation.progress.update.enabled</code>|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>false</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>Whether to enable get operation progress percentage.</div>|<div style='width: 30pt'>boolean</div>|<div style='width: 20pt'>1.4.0</div>
<code>kyuubi.operation.progress.update.interval</code>|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>PT10S</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>The interval to get operation progress percentage.</div>|<div style='width: 30pt'>duration</div>|<div style='width: 20pt'>1.4.0</div>
...
<code>kyuubi.operation.submit.conf.ignore.list</code>|<div style='width: 65pt;word-wrap: break-word;white-space: normal'></div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>A comma separated list of ignored keys. If the submit command conf contains any of them, the key and the corresponding value will be removed silently during executing submission. Note that: some config items could be defined in server side with `operation.submit.conf.spark` prefix</div>|<div style='width: 30pt'>seq</div>|<div style='width: 20pt'>1.5.0</div>
