...
<code>kyuubi.authentication.batchAccount.class</code>|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>&lt;undefined&gt;</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>The authentication class name for batch account authentication, eBay internal requirement</div>|<div style='width: 30pt'>string</div>|<div style='width: 20pt'>1.5.0</div>
...
<code>kyuubi.engine.jdbc.connection.password</code>|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>&lt;undefined&gt;</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>The password is used for connecting to server</div>|<div style='width: 30pt'>string</div>|<div style='width: 20pt'>1.6.0</div>
<code>kyuubi.engine.jdbc.connection.properties</code>|<div style='width: 65pt;word-wrap: break-word;white-space: normal'></div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>The additional properties are used for connecting to server</div>|<div style='width: 30pt'>seq</div>|<div style='width: 20pt'>1.6.0</div>
<code>kyuubi.engine.jdbc.connection.provider</code>|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>&lt;undefined&gt;</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>The connection provider is used for getting a connection from server</div>|<div style='width: 30pt'>string</div>|<div style='width: 20pt'>1.6.0</div>
<code>kyuubi.engine.jdbc.connection.url</code>|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>&lt;undefined&gt;</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>The server url that engine will connect to</div>|<div style='width: 30pt'>string</div>|<div style='width: 20pt'>1.6.0</div>
...
<code>kyuubi.operation.max.result.count</code>|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>0</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>Max rows of Spark query results. Rows that exceeds the limit would be ignored. By setting this value to 0 to disable the max rows limit.</div>|<div style='width: 30pt'>int</div>|<div style='width: 20pt'>1.6.0</div>
...
<code>kyuubi.operation.spark.listener.enabled</code>|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>true</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>When set to true, Spark engine registers a SQLOperationListener before executing the statement, logs a few summary statistics when each stage completes.</div>|<div style='width: 30pt'>boolean</div>|<div style='width: 20pt'>1.6.0</div>
...
Key | Default | Meaning | Type | Since
--- | --- | --- | --- | ---
<code>kyuubi.server.ha.zookeeper.enabled</code>|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>true</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>Whether to enable the ha zookeeper discovery in server side</div>|<div style='width: 30pt'>boolean</div>|<div style='width: 20pt'>1.4.0</div>
...
<code>kyuubi.session.cluster</code>|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>&lt;undefined&gt;</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>The cluster to access, such as apollo-rno, hercules-lvs.  For each cluster, there should be a defined properties file, whose name is formatted like kyuubi-defaults.conf.<cluster></div>|<div style='width: 30pt'>string</div>|<div style='width: 20pt'>1.4.0</div>
<code>kyuubi.session.cluster.mode.enabled</code>|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>false</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>Whether to enable session with cluster specify mode. If it is enabled, the cluster for session connection is must to be specified.</div>|<div style='width: 30pt'>boolean</div>|<div style='width: 20pt'>1.4.0</div>
...
<code>kyuubi.session.engine.launch.moveQueue.enabled</code>|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>false</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>When opening kyuubi session, whether to launch engine at first and then move queue. Note that, it is only for yarn resource manger.</div>|<div style='width: 30pt'>boolean</div>|<div style='width: 20pt'>1.4.0</div>
<code>kyuubi.session.engine.launch.moveQueue.initQueue</code>|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>&lt;undefined&gt;</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>When launch engine and move queue, the init queue.</div>|<div style='width: 30pt'>string</div>|<div style='width: 20pt'>1.6.0</div>
<code>kyuubi.session.engine.launch.moveQueue.timeout</code>|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>PT2M</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>When launch engine and move queue, the final queue.</div>|<div style='width: 30pt'>duration</div>|<div style='width: 20pt'>1.6.0</div>
...
<code>kyuubi.session.engine.request.timeout</code>|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>PT0S</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>The timeout of awaiting response after sending request to remote sql query engine</div>|<div style='width: 30pt'>duration</div>|<div style='width: 20pt'>1.4.0</div>
